	...
	<view class="my-center">
		...
		<scroll-view class="container" scroll-y="true">
			...
			<view class="recent_orders">
				...
				<!-- 最近订单列表 -->
				<view class="order_lists" v-for="(item, index) in recentOrdersList" :key="index" @click="goDetail(item.id)">
					<!-- 时间和支付状态 -->
...
export default {
	...
	onLoad () {
		this.psersonUrl = (this.$store.state.baseUserInfo && this.$store.state.baseUserInfo.avatarUrl) || '../../static/avatar_default.png'
		this.nickName = (this.$store.state.baseUserInfo && this.$store.state.baseUserInfo.nickName) || '吃货'
