  ...
  routes: [
    {
      ...
      meta: { title: "老吴外卖", hidden: true, notNeedAuth: true }
    },
    {
      path: "/404",
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "agent-sessions",
          component: () => import(/* webpackChunkName: "agent-sessions" */ "@/views/agentSessions/index.vue"),
          meta: { title: "客服会话", icon: "icon-order" }
        },
        
        {
          path: "faq",
          component: () => import(/* webpackChunkName: "faq" */ "@/views/faq/index.vue"),
          meta: { title: "FAQ 管理", icon: "icon-category" }
        },
        {
          path: "/employee/add",
          component: () =>
